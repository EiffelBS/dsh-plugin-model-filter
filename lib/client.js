...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// DSH 0.1.7 replaced fixed-size icon exports with weight-suffixed names.
		function iconComponent(modernName, legacyName) {
			const component = _deepseek_ai_dsh_client_ui_primitives[modernName] ?? _deepseek_ai_dsh_client_ui_primitives[legacyName];
			if (typeof component !== "function") throw new Error(`dsh-plugin-model-filter: required icon ${modernName}/${legacyName} is unavailable`);
			return component;
		}
		const IconDataOutline = iconComponent("IconDataOutlineRegular", "IconDataOutline16");
		const IconChevronDownOutline = iconComponent("IconChevronDownOutlineRegular", "IconChevronDownOutline14");
		const IconChevronRightOutline = iconComponent("IconChevronRightOutlineRegular", "IconChevronRightOutline14");
		const IconCheckOutline = iconComponent("IconCheckOutlineRegular", "IconCheckOutline16");
		const IconWarningOutline = iconComponent("IconWarningOutlineRegular", "IconWarningOutline16");
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							(0, react_jsx_runtime.jsx)(IconDataOutline, {
							...
							(0, react_jsx_runtime.jsx)(IconChevronDownOutline, { className: clsx(ModelSelect_module_css_default.chevron, open && ModelSelect_module_css_default.chevronOpen) })
						]
					}),
						...
						children: [
							pane === "root" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)(IconChevronRightOutline, { className: ModelSelect_module_css_default.cellChevron })
								]
											...
											children: [(0, react_jsx_runtime.jsx)("div", {
												...
												return (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [(0, react_jsx_runtime.jsx)("span", {
														...
														children: selected ? (0, react_jsx_runtime.jsx)(IconCheckOutline, {}) : null
													})]
												}, model.id);
											})]
										}, group.id);
							...
							pane === "effort" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [state.error !== null && lastActionRef.current === "load" && (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", {
									...
									className: ModelSelect_module_css_default.check,
									children: effectiveEffort === level.effort ? (0, react_jsx_runtime.jsx)(IconCheckOutline, {}) : null
								})]
							}, level.key))] })
						]
					}), document.body),
					toast !== null && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Toast, {
						text: toast.text,
						icon: (0, react_jsx_runtime.jsx)(IconWarningOutline, {}),
				...
				scope.slots.inject("conversation.input.model", () => scope.slots.register({
					...
					inject: (sessionId) => {
						...
						return {
							...
							// DSH 0.1.5 resolved void; DSH 0.1.7 resolves RemoteResult.
							select: (selection) => available ? directory.select(selection).then((result) => result === void 0 || result === true || result?.ok === true, () => false) : Promise.resolve(false)
						};
					}
				}, ModelSelect));
			});
